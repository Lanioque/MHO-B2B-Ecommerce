  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col">
      ...
      <div className="flex-grow">
        <SidebarShell>
          <SidebarInset>
            <header className="sticky top-0 h-16 z-50 flex items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12 bg-white border-b shadow-sm">
